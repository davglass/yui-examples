...
<html>
<head>
    <title>YUI: Layout Manager: Left Collapse Issue</title>
...
<div id="davdoc" class="yui-t7">
    <div id="hd"><h1 id="header"><a href="http://blog.davglass.com/">YUI: Layout Manager: Left Collapse Issue</a></h1></div>
    <div id="bd">
    <p>This patch was built for <a href="https://sourceforge.net/tracker/?func=detail&atid=836476&aid=1901621&group_id=165715">SourceForge Bug #1901621.</a></p>
    <p><a href="example.php" target="_blank">View Example</a></p>
    <h2>The Javascript for the Patch</h2>
    <a href="patch-min.js">Minimized version of the patch.js file</a>
