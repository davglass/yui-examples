...
<html>
<head>
    <title>YUI: Layout Manager: TabView Example</title>
...
<div id="davdoc" class="yui-t7">
    <div id="hd"><h1 id="header"><a href="http://blog.davglass.com/">YUI: Layout Manager: TabView Example</a></h1></div>
    <div id="bd">
    <p>This example was built for this <a href="http://tech.groups.yahoo.com/group/ydn-javascript/message/26349">YDN Javascript thread.</a></p>
    <p><a href="example.php" target="_blank">View Example</a></p>
    <h2>HTML that was changed</h2>
    <textarea name="code" class="HTML">
<body class=" yui-skin-sam">
<div id="demo">
</div>
<!-- Moved the includes to the bottom of the page and removed the duplicate links and used the rollup for utilities.js -->
