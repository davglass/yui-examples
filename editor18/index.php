...
<html>
<head>
    <title>YUI: Editor w/ behaviour.js</title>
...
<div id="davdoc" class="yui-t7">
    <div id="hd"><h1 id="header"><a href="http://blog.davglass.com/">YUI: Editor w/behaviour.js</a></h1></div>
    <div id="bd">
        <p>This page contains YUI RTE 2.4.1 and behaviour.js</p>
        <h2>Editor #1</h2>
