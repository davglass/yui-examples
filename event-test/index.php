...
<div id="davdoc" class="yui-t7">
    ...
    <div id="bd">
        <p>This test uses a single Element instance to set attributes. It creates 5 elements, then sets 30 attributes 50 times on each element.</p>
        <h2>Results</h2>
        <div id="results"></div>
        <div id="test1"></div>
        <div id="test2"></div>
...
<script type="text/javascript" src="event-test1.js"></script> 
