    ...
    */
    ...
    YAHOO.util.Event.onDOMReady(
        ...
        function() {
            ...
            //CHANGED resizablepanel to resizeablepanel_c (with is the parent container of the panel)
            var resize = new YAHOO.util.Resize('resizablepanel_c', {
                handles: 'all',
                autoRatio: false,
                //ADDED WIDTH TO THE CONFIG
                width: 500,
                minWidth: 300,
                minHeight: 100,
                status: true
            ...
            resize.on('resize', function(args) {
                ...
                //ADDED WIDTH CHECK AND SET STYLE
                if (args.width) {
                    YAHOO.util.Dom.setStyle(this.innerElement, 'width', args.width + 'px');
                }
...
<body class=" yui-skin-sam">
    ...
    <div id="examplecontainer">
        ...
        <button id="setabsolute" onclick="document.getElementById('resizablepanel').style.position='absolute'">Set $('resizablepanel').style ='absolute'</button>
