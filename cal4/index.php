...
<div id="davdoc" class="yui-t7">
    <div id="hd"><h1 id="header"><a href="http://blog.davglass.com/">YUI: Calendar Date Error</a></h1></div>
    <div id="bd">
...
<script type="text/javascript" src="calendar-2.4.js"></script>
...
(function() {
    var Dom = YAHOO.util.Dom,
		...
		Event.addListener(window, "load", function() {
			var cal1 = new YAHOO.widget.Calendar("YAHOO.example.calendar.cal1","cal1Container");
			cal1.render();
		});
