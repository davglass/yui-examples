...
<link rel="stylesheet" type="text/css" href="http://yui.yahooapis.com/2.5.1/build/layout/assets/skins/sam/layout.css" />
...
<div id="bottom1">
This is it's own title.  I want the div below to scroll independently if needed.
    ...
    Event.onDOMReady(function() {
        var layout = new YAHOO.widget.Layout({
            units: [
                ...
                { position: 'bottom', header: 'Bottom', height: 100, resize: true, body: 'bottom1', gutter: '5px', collapse: true, scroll: false },
