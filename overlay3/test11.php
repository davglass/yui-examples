...
<a href="" id="test1">Show a panel with the following event subscribers:<p>beforeRenderEvent, changeHeaderEvent, changeBodyEvent</p></a>
<a href="" id="test2">Show a panel with the following event subscribers:<p>beforeRenderEvent, renderEvent, changeHeaderEvent, changeBodyEvent, beforeShowEvent, showEvent, beforeHideEvent, hideEvent, showMaskEvent, hideMaskEvent</p></a>
<a href="" id="test3">Show a panel with the following event subscribers:<p>renderEvent, beforeShowEvent, showEvent, beforeHideEvent, hideEvent, showMaskEvent, hideMaskEvent</p></a>
<script type="text/javascript" src="../js/yahoo-min.js"></script>
<script type="text/javascript" src="../js/dom-min.js"></script>
<script type="text/javascript" src="./event-011.js"></script>
<script type="text/javascript" src="../js/animation-min.js"></script>
<script type="text/javascript" src="../js/dragdrop-min.js"></script>
<script type="text/javascript" src="./container-011.js"></script>
