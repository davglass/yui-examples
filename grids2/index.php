...
<html>
<head>
    <title>YUI: Grids 100% Height</title>
        <link rel="stylesheet" href="../css/yuicss.css" type="text/css">
...
<div id="doc" class="yui-t2"><!-- possible values: t1, t2, t3, t4, t5, t6, t7 -->
    ...
    <div id="bd">
        ...
        <div class="yui-b" id="nav">
            <!-- start: your content here -->
            <p>SECONDARY: Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas sit amet metus. Nunc quam elit, posuere nec, auctor in, rhoncus quis, dui. </p>
            <!-- end: your content here -->                     
        </div>
