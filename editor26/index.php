...
<html>
<head>
    <title>YUI: Editor Safari Tab Fix</title>
...
<div id="davdoc" class="yui-t7">
    <div id="hd"><h1 id="header"><a href="http://blog.davglass.com/">YUI: Editor Safari Tab Fix</a></h1></div>
    <div id="bd">
...
myEditor.browser.safari = myEditor.browser.webkit;
myEditor.render();    
    </textarea>
    </div>
    <div id="ft">&nbsp;</div>
